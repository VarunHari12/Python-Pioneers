...
number = random.randint(1,100) # this fucntion returns a random integer in the range of the 2 numbers specified
print(number)

number = random.random() # this will return a random decimal from 0-1
print(number)

number = random.randrange(1,100,2) # this function is similar to randint but the endrange is not included
